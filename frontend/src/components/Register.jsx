  ...
  return (
    <div className="sc-auth-wrapper sc-auth-wrapper-compact">
      <div className="sc-auth-shell">
        <aside className="sc-auth-visual" aria-label="Unispot branding panel">
          <div className="sc-auth-visual-content">
            <div className="sc-auth-brand-mark">
              <i className="bi bi-buildings-fill"></i>
            </div>
            <h1 className="sc-auth-brand-title">unispot</h1>
            <p className="sc-auth-brand-subtitle">Book spaces faster, manage assets smarter, and keep campus life moving.</p>
          </div>
        </aside>
          ...
          <div className="sc-auth-form-inner">
            <div className="card sc-auth-card">
              <div className="sc-auth-header">
                ...
                <p className="mb-0 opacity-75" style={{fontSize:'0.9rem'}}>Join unispot</p>
              </div>
              ...
              <div className="card-footer text-center bg-light py-2">
