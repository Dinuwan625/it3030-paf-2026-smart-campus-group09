...
function MyBookings() {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_URL}/bookings/user/${user.userId}`, { withCredentials: true })
                  ...
                  {bookings.map(b => (
                    <tr key={b._id}>
                      ...
                      <td style={{ maxWidth: 200 }}>
                        <span title={b.purpose} style={{ display: 'block', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 180 }}>
                          {b.purpose}
                        </span>
                      </td>
                      ...
                      <td style={{ maxWidth: 240 }}>
                        <span
                          ...
                          style={{ display: 'block', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 225 }}
                        >
...
// you can book a resources within this page. So there are three types (Avalible,booked,under maintaince)types 
