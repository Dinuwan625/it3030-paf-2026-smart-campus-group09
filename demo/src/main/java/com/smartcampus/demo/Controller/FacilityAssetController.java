...
public class FacilityAssetController {
    ...
    /** Any authenticated user can create a facility asset entry. */
    @PostMapping("/save")
    ...
    /** Any authenticated user can get public facility assets by user ID. */
    ...
    /** Any authenticated user can get facility assets by status. */
    ...
    /** Any authenticated user can get facility assets by user ID and status. */
    ...
    /** Any authenticated user can get a facility asset by ID. */
    @GetMapping("/{id}")
    ...
    /** Any authenticated user can update a facility asset entry. */
    @PutMapping("/edit/{id}")
    ...
    /** Any authenticated user can delete a facility asset entry. */
